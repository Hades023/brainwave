...
const Button = forwardRef(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 rounded-lg disabled:cursor-not-allowed disabled:opacity-50";
