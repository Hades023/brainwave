    ...
    <>
      ...
      */}
        ...
        */}
          <div className="mt-6">
            <button
              className={`${color} ${rounded} ${border} ${textSize}  px-6 py-3 text-white font-medium transition focus:outline-none focus:ring-2 focus:ring-indigo-400`}
            >
              Tailwind Button
            </button>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-4">
            ...
            <Control label="Border Style">
              <Select
                value={border}
                onChange={setBorder}
                options={["border-0", "border-2", "border-4", "border-6"]}
              />
            </Control>
          </div>
